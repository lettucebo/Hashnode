...
cover: https://cdn-images-1.medium.com/max/800/0*1ZLWcAZdRPQcZEkj.jpg
...
![](https://cdn-images-1.medium.com/max/800/0*1ZLWcAZdRPQcZEkj.jpg)
...
![](https://cdn-images-1.medium.com/max/800/1*vOsdFTb3tbr7a_6g0Rbq-Q.png)
...
![](https://cdn-images-1.medium.com/max/800/1*0DBTWsJlNJFCpz6zUgJL3Q.png)
...
![](https://cdn-images-1.medium.com/max/800/1*fAL0ypM0tBHHVDa8EnFugg.png)
...
![](https://cdn-images-1.medium.com/max/800/1*21bJIBob1NGgto9aRn1TRw.png)

* 示範臉部偵測與表情辨識

我這邊程式就直接使用從 Url 方式來拿到圖片的方式，這邊照片就使用剛剛的範例照片

![](https://cdn-images-1.medium.com/max/800/0*WVev4lO0ZXp6tDed)
...
![](https://cdn-images-1.medium.com/max/800/1*PzFVdtJZ5jXwMFH5dhmtig.png)
